...
%%this puts encoding in footnote and underlines text
%%comment out for barcode and comment in below...
\def\encode#1#2{\underline{#2}\footnotemark[#1] }
...
%%uncomment following line to get barcodes
%\def\encode#1#2{\mbox{\sbox{\mytextbox}{#2}\settowidth{\gwboxwidth}{#2}\dimen1=\gwboxwidth \divide\dimen1 by18 \ifdim\dimen1<\minwid \dimen1=\minwid \fi \sbox{\mycodesbox}{\bcode{\dimen1}{#1}}\settowidth{\gwcodeboxwidth}{\bcode{\dimen1}{#1}}\dimen1=\gwboxwidth \ifdim\dimen1<\gwcodeboxwidth \dimen1=\gwcodeboxwidth \fi  \makebox[\dimen1]{\usebox{\mytextbox}}\hspace{-\dimen1}\makebox[\dimen1]{\usebox{\mycodesbox}} } % and uncomment next line!!!!!!!!!!!!!!!!!!!
%}
