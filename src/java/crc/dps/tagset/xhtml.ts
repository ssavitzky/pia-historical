...
<tagset name=xhtml parent=HTML include=xxml recursive>
...
<doc> This tagset consists of the primitive operations from the <a
      ...
      convenience functions of <a href="xxml.html">standalone</a>, and
      HTML syntax.  It is intended for use in eXtended HTML documents.
</doc>

This file contains the XML definition for the <code>xhtml</code> Tagset.  It
