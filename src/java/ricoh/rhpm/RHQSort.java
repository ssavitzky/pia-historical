 ...
 */
public class RHQSort // extends SortAlgorithm 
{
    ...
    */
   void QuickSort(RHSortableConcept concepts[], int lo0, int hi0) throws Exception  // RH Mod
   {
      int lo = lo0;
      int hi = hi0;
      int mid;
   ...
   private void swap(RHSortableConcept a[], int i, int j) // RH Mod
   {
      RHSortableConcept T; // RH Mod
      T = a[i]; 
      a[i] = a[j];
      a[j] = T;
   ...
   public void sort(RHSortableConcept a[]) throws Exception // RH Mod
   {
