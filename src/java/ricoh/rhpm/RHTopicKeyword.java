...
public class RHTopicKeyword implements Serializable {
  ...
  RHTopicKeyword(String[] newphrases) {
    int i=0;
    phrase=new String[newphrases.length];
    for (i=0;i<RH_GlobalVars.maxNumberKeywords && i<newphrases.length && newphrases[i]!=null; i++)
