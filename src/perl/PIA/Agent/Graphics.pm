package PIA::Agent::Graphics; ###### The "Graphics" agent.
###	$Id$
###	Copyright 1997, Ricoh California Research Center.
###
###	This may eventually become the superclass for all agents that
###	produce graphics.  At the moment it's just the thumbnailer.
###
